...
AmCharts.addInitHandler( function( chart ) {
	var _this = {
		...
		init: function( chart ) {
			...
			if ( typeof _this.config.menuContainer == "string" ) {
				_this.config.menuContainer = document.getElementById(_this.config.menuContainer);
			} else if ( !(_this.config.menuContainer instanceof Element) ) {
				_this.config.menuContainer = _this.setup.chart.containerDiv;
			}
			_this.createMenu( _this.config.menu, _this.config.menuContainer );
		}
	}
